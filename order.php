<?php include('partials-front/menu.php'); ?>
    ...
    <?php 
        //CHhck whether id is set or not
    ...
    <section class="item-searchorder">
        <div class="container">
            ...
            <form action="" method="POST" class="order">
                ...
                <fieldset>
                    ...
                    <input type="text" name="full-name" placeholder="E.g.Shahinur Yeasmin" class="input-responsive" required>

                    <div class="order-label">Phone Number</div>
                    <input type="tel" name="contact" placeholder="E.g. 01*********" class="input-responsive" required>

                    <div class="order-label">Email</div>
                    <input type="email" name="email" placeholder="E.g. pritha.6782@gmail.com" class="input-responsive" required>
